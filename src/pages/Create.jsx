...
const Create = () => {
  ...
  return (
    <div>
      <img src="/assets/flower-japan.svg" alt="" className="h-[5.5vh] w-[4.5vw] absolute top-34 left-60 " />
      <img src="/assets/flower-japan.svg" alt="" className="h-[5.5vh] w-[4.5vw] absolute top-134 left-20 " />
      <img src="/assets/flower-japan.svg" alt="" className="h-[5.5vh] w-[4.5vw] absolute top-94 left-280 " />
     
      <img src="/assets/leaf-1.svg" alt="" className="h-[5.5vh] w-[4.5vw] absolute top-100 left-90 " />
      <img src="/assets/leaf-2.svg" alt="" className="h-[5.5vh] w-[4.5vw] absolute top-150 left-220 " />
      <img src="/assets/leaf-3.svg" alt="" className="h-[5.5vh] w-[4.5vw] absolute top-35 left-150 " />
      <div className="bg-[#be3740] w-[55%] mx-auto mt-20 rounded-2xl overflow-hidden">
      
      <h1 className="font-[Lora] text-3xl text-center mt-5 text-[#feefdf] -mb-1 ">Create New Recipe </h1>
